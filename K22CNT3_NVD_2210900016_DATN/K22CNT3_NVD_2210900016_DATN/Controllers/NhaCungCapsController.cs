...
namespace K22CNT3_NVD_2210900016_DATN.Views
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_NCC,TenNCC,DiaChi,DienThoai,Email")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_NCC,TenNCC,DiaChi,DienThoai,Email")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
