...
namespace K22CNT3_NVD_2210900016_DATN.Controllers
{
    public class QuanTrisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_QT,TaiKhoan,MatKhau,VaiTro,TrangThai")] QuanTri quanTri)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_QT,TaiKhoan,MatKhau,VaiTro,TrangThai")] QuanTri quanTri)
        {
            if (ModelState.IsValid)
            {
